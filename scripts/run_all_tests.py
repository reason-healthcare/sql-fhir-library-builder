...
class TestRunner:
    ...
    def __init__(self):
        ...
        self.test_files = [
            ...
            ('tests/test_multiple_dependencies.py', 'Multiple Dependencies Support Tests'),
    ...
    def generate_summary_report(self):
        ...
        for result in self.results:
            ...
            print(f"   {status_emoji} {result['file']:<30} {result['status']:<8} ({result['execution_time']:.2f}s)")
        ...
        if self.failed_tests == 0:
            print("🎉 ALL TESTS PASSED! The SQL FHIR Library Generator is working correctly.")
        else:
            print(f"❌ {self.failed_tests} test(s) failed. Please review the output above.")
