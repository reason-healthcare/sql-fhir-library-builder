...
def main():
    parser = argparse.ArgumentParser(
        description="Test commands for SQL Annotation Parser"
    )
    ...
    if args.command == "test":
        return run_command(
            "python run_all_tests.py", "Running comprehensive test suite"
        )
        ...
        return run_command(
            "python test_fhir_integration.py", "Testing FHIR integration"
        )
        ...
        return run_command(
            "python test_fhir_integration.py", "Running integration demo"
        )
