...
def test_dialect_version():
    ...
    test_files = [
        ('examples/hive_with_version.sql', 'application/sql; dialect=hive; version=3.1.2', 'Hive 3.1.2'),
        ('examples/postgres_with_version.sql', 'application/sql; dialect=postgres; version=15.4', 'PostgreSQL 15.4'),
        ('examples/hive_example.sql', 'application/sql; dialect=hive', 'Hive (no version)'),
        ('examples/sql_on_fhir_example.sql', 'application/sql', 'Standard SQL (no dialect or version)')
    ]
