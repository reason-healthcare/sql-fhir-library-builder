...
class FHIRLibraryBuilder:
    ...
    def build_library_from_file(
        self, sql_file_path: Union[str, Path], library_id: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        return self.build_library_from_content(
            sql_content, annotations, library_id, sql_file_path.name
        )

    def build_library_from_content(
        self,
        sql_content: str,
    ...
    def _get_annotation_value(
        self, annotations: Dict[str, Any], key: str, default: Any = None
    ) -> Any:
    ...
    def _apply_annotations_to_library(
        self, library: Dict[str, Any], annotations: Dict[str, Any]
    ):
    ...
    def _format_contact(self, contact_str: str) -> List[Dict[str, Any]]:
        ...
        return [{"name": contact_str, "telecom": []}]
    ...
    def _format_jurisdiction(
        self, jurisdiction: Union[str, List[str]]
    ) -> List[Dict[str, Any]]:
    ...
    def _add_additional_metadata(
        ...
        if "relatedDependency" in annotations:
            ...
            for dep in dependencies:
                related_artifact = {"type": "depends-on", "resource": str(dep).strip()}
    ...
    def export_library_to_file(
        self, library: Dict[str, Any], output_path: Union[str, Path]
    ):
        """
