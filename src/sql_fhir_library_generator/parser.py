...
class SQLAnnotationParser:
    ...
    def __init__(self):
        ...
        self.multi_line_comment_pattern = re.compile(r'/\*\s*(.*?)\s*\*/', re.DOTALL | re.IGNORECASE)
    ...
    def parse_multiple_files(self, file_paths: List[Union[str, Path]]) -> Dict[str, Dict[str, Any]]:
        """
